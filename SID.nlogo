...
to setup
 ...
 ;;https://www.css.cnrs.fr/the-augmented-social-scientist-tutorial-at-ic2s2/ ask n-of 1 patches [ sprout-flags 1 [ set shape "flag" set size 5] ]
  ask n-of Agents patches [ sprout-simuls 1 [ set color red set shape "arrow" set orientation heading set IDa random 1000 set IDb random 1000 set IDC random 1000 set IDd random 1000 set IDe random 1000 ] ]
   reset-ticks
end
...
to disturb
  ask n-of disturbed simuls [
      set orientation random 360
    ]
end
