    ...
    if any? other humans in-radius exploration and count ideas < abs (count humans * .5)  [
      hatch-ideas 1 [
        ...
        ask one-of other humans-here [
          create-hidealink-with new_idea [ set power random 100 ]
        ]
      ]
    ]
  ]
  ...
  ask n-of 1 humans [
    if any? other humans in-radius exploration_entities and count entities < abs (count humans * .5)  [
      hatch-entities 1 [
        ...
        ask one-of other humans-here [
          create-entitylink-with new_entity [ set power random 100 ]
...
"" ""
PENS
"Health / Status" 1.0 0 -16777216 true "" "plot mean [ xcor + ycor ] of humans"
